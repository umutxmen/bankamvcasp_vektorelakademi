...
{
  [SessionAspect]
  public class MusteriData2Controller : Controller
  {
        private readonly IHttpApiService _httpApiService;
        private readonly IWebHostEnvironment _webHost;

        public MusteriData2Controller(IHttpApiService httpApiService, IWebHostEnvironment webHost)
        {
        ...
        public async Task<IActionResult> Index()
        {
            ...
            var token = HttpContext.Session.GetObject<AccessTokenItem2>("AccessToken");

            // HTTP API servisi kullanarak verileri çekme
            var response = await _httpApiService.GetData<ResponseBody2<List<MusteriDataItem2>>>("/musteridata");
        ...
        [HttpPost]
        public async Task<IActionResult> GetMusteriData2(int id)
        {
            var response =
              await _httpApiService.GetData<ResponseBody2<MusteriDataItem2>>($"/musteridata/{id}");
        ...
        [HttpPost]
        public async Task<IActionResult> Save(NewMusteriDataItemDto2 dto, IFormFile musteriPhoto)
        {
            ...
            if (musteriPhoto != null)
            {
                ...
                var response = await _httpApiService.PostData<ResponseBody2<MusteriDataItem2>>("/musteridata", JsonSerializer.Serialize(postObj));
        ...
        [HttpPut]
        public async Task<IActionResult> Update(PutMusteriDataItem2 dto, IFormFile musteriPhoto)
        {
                ...
                var putObj = new
            {
                ...
                var response = await _httpApiService.PutData<ResponseBody2<MusteriDataItem2>>("/musteridata", JsonSerializer.Serialize(putObj));
        ...
        public async Task<IActionResult> Delete(int id)
        {
            ...
            var response = await _httpApiService.DeleteData<ResponseBody2<NoData>>($"/musteridata/{id}");
